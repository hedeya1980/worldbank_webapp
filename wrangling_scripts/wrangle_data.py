...
def cleandata(dataset, countries, keepcolumns = ['Country Name', '1990', '2015'], value_variables = ['1990', '2015']):
...
def return_figures(countries=country_default):
  ...
  # as a line chart
    ...
    graph_one = []
    df = cleandata('data/API_AG.LND.ARBL.HA.PC_DS2_en_csv_v2.csv', countries)
...
# third chart plots percent of population that is rural from 1990 to 2015
    graph_three = []
    df = cleandata('data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_9948275.csv', countries)
...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', countries, keepcolumns, valuevariables)
    df_two = cleandata('data/API_AG.LND.FRST.K2_DS2_en_csv_v2_9910393.csv', countries, keepcolumns, valuevariables)
    ...
    graph_five = []
    df_five = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', countries, ['Country Name', '2015'], ['2015'])
